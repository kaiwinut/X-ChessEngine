...
// This function basically generates all possible combinations of occupancies given a relevant occupancy mask of a bishop / rook
...
{
	// Initialize magics (Not needed since already initialized as constants)
	// initMagics();
	...
	/*** Uncomment this to check the relevant occupancy masks ***/
	// for (int index = 0; index < 4096; index ++)
	// {
	// 	displayBitboard(generateOccupancyMasks(index, countBits(ROOK_RELEVANT_OCCUPANCY[D5]), ROOK_RELEVANT_OCCUPANCY[D5]));
	// 	string x;
	// 	cin >> x;
	// }
